...
Wovodat.getEquakeTypeList = function(handler, mapUsed) {
    $.ajax({
        method: "get",
        url: "/php/switch.php",
...
Wovodat.getLatLon = function(args, volcId, mapId, mapUsed){
    ...
    var zoom_level = args.zoom_level;
    $.ajax({
        method: "get", 
        url: "/php/switch.php",
        ...
        success: function(html){
            ...
            handler({
                ...
                lon:html[1],
                elev:html[2]
            },volcId, mapId,mapUsed, zoom_level);
        }
    });
};
...
Wovodat.getCatalogOwner = function(handler){
    $.ajax({
        method:"get",
        url: "/php/switch.php",
        data:"get=CatalogOwner",
        dataType: 'json',
...
Wovodat.getEquakeType = function(handler){
    $.ajax({
        method:"get",
        url: "/php/switch.php",
        data:"get=EquakeType",
...
*2012-07-26
*/
Wovodat.getNeighbors=function(cavw, panelUsed, handler, zoom_level){
    $.ajax({
        method:"get",
        url:"/php/switch.php",
        ...
        success:function(html){
            if(html.indexOf('Can\'t') >= 0) return;
            var list = html.split("&");
            handler(cavw,list,panelUsed,zoom_level);
        }
    });
}
/*
...
Wovodat.getAllStationsList = function (args){
    ...
    $.ajax({
        ...
        success: function(html){
            ...
            handler({
                list:html
            },tableId,mapId, stationsDatabaseUsed,mapUsed, zoom_level);
        }
    });
};
