...
<html>
    <head>
        ...
        <script type="text/javascript" src="/js/jquery-1.4.2.min.js"></script><!-- Nhat added 18 June -->
    </head>
                            ...
                            <td class="welcome">
                                ...
                                <p>
                                    <span style = "font-size:13px">
                                        WOVOdat Database uses formats and data structure as described in <a href="/docum/database/1.0/wovodat10_doc.pdf" title="download WOVOdat pdf 1.0 file" target="_blank" style = "color:blue">WOVOdat1.0 (Venezky and Newhall, 2007)</a>. The current version is WOVOdat1.1. The overall structure was retained from v1.0 to v1.1; most changes are in the details of parameters.<br><br>
                            ...
                            <td valign = "top">
                                <div class="download" >
                                    ...
                                    <ul>
                                        ...
                                        <p >WOVOdat1.1 Manual <a href="/docum/database/1.1/wovodat11_doc.pdf" title="download WOVOdat pdf file" target="_blank">(pdf)</a>
                                        </p>
                                        <li><p> Detail description of WOVOdat Tables </p> </li>
                                        <p >WOVOdat1.1 Tables<a href="/docum/database/1.1/index.php" title="view WOVOdat Table on-line">(online view)</a>
                                        </p>
                                        <li> <p>Introduction how to use WOVOdat </p></li>
                                        <p>Introduction to using WOVOdat <a href="/docum/system/IntroductionToUseWOVOda_Feb2014.pdf" title="view WOVOdat Introduction" target="_blank">(pdf)</a>
                                        </p>
                                    </ul>
                                    <h3 style="padding:10px 35px 0px 20px;text-decoration: underline;">Database schema and structure</h3>
                                    <ul>
                                        <li><p>WOVOdat Schema xsd</p>
                                        <p>WOVOml1.1.0 Schema <a href="/docum/system/1.1.0/wovoml_schema.xsd" title="view WOVOml descriptions" title="view WOVOml descriptions" target="_blank">(online view)</a>
                                        </p>
                                        </li>
                                        <li><p>WOVOdat structure in XML format and their related MySQL's attributes</p>
                                            <p>WOVOdat XML <a href="/docum/system/1.1.0/wovoml_110.php" title="view WOVOml upload descriptions">(online view)</a>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
