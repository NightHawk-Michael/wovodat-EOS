...
if(isset($data[1])){ 	
	...
	echo "<h1 class='nosatelliteerror' style='text-align: left;color: #777777;font-size:12px;font-weight: bold;'>No Airborne for this volcano!<br/> Please create an airborne first!</h1>";	
}	
