...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function convertspecificfile(obs_filename, type){   	
			$("#submitfile2").hide();
			if (type == 5) 
				$.get('/populate/convert_specific_csvfile_' + obs_filename + '.php?obsfilename=' + obs_filename + 'andobs=' + '<?php echo $observatory ?>' + 'andtipedata=specific',show_form_submit_common);
			else $.get('/populate/convert_specific_csvfile_' + obs_filename + '.php?obsfilename=' + obs_filename + 'andobs=' + '<?php echo $observatory ?>' + 'andtipedata=specific',show_form_submit);
		}
...
/*		
		var naclick = '<?php echo $_GET['back_to_previous'];?>'
		if (naclick=='yes'){
			uploadform();
		}
*/		
