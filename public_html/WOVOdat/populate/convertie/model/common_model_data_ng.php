...
function getstationcode($station,$conv){  // All Instruments xmls need station codes
	...
	else if($conv == 'ElectronicTiltData' || $conv == 'TiltVectorData' || $conv == 'StrainMeterData' || $conv == 'GPSVectors'  || $conv == 'EDMData' || $conv == 'AngleData' || $conv == 'GPSData' || $conv == 'LevelingData'){
...
function getstation2code($station2,$conv){  
	...
	if($conv == 'EDMData' || $conv == 'AngleData' || $conv == 'GPSData' || $conv == 'LevelingData'){
...
function getinstrcode($instrument,$conv){
	...
	if($conv == 'ElectronicTiltData' || $conv == 'TiltVectorData'){
		...
		$sql="select distinct di.di_gen_code as instrcode from di_gen as di where di.di_gen_name='$instrument' and (di.di_gen_type ='EDM' OR di.di_gen_type ='EDM Reflector' OR di.di_gen_type ='Total_Station' OR di.di_gen_type ='OtherTypes')";
	}else if($conv == 'AngleData'){
		$sql="select distinct di.di_gen_code as instrcode from di_gen as di where di.di_gen_name='$instrument' and (di.di_gen_type ='Angle' OR di.di_gen_type ='Total_Station' OR di.di_gen_type ='OtherTypes')";
	}else if($conv == 'LevelingData'){
		$sql="select distinct di.di_gen_code as instrcode from di_gen as di where di.di_gen_name='$instrument' and (di.di_gen_type ='Total_Station' OR di.di_gen_type ='OtherTypes')";
