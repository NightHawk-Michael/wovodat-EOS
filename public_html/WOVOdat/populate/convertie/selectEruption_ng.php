...
$dataType=trim($_GET["dataType"]);    
	...
	if(isset($data)){
		...
		echo "<h1 class='noeruptionerror' style='text-align: left;color: #777777;font-size:12px;font-weight: bold;'>No eruption time!<br/> Please create an eruption data first!</h1>";
	}
