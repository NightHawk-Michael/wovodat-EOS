...
<script language='javascript' type='text/javascript'>
	...
	<div class="form">
		...
		<h3>Upload online form for deformation station (Table Name: ds) </h3>

		<span> (All fields * are required) </span>
	
		<p class="redtext"><?php if ($error) {print "Registration unsuccessful! Please correct the fields in red:";} ?></p>
	
		<form method="post" action="insertSwitch.php" name="form_ds" id="form_ds">
...
echo <<<HTMLBLOCK
				...
				<tr>
					...
					<td>
						<input type="text" maxlength="30" id="ds_code" name="ds_code" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" maxlength="30" id="ds_name" name="ds_name" value="" />
					</td>
				</tr>				
				...
				<tr>
					...
					<td>
						<input type="text" maxlength="255" id="ds_perm" name="ds_perm" value="" />
					</td>
				</tr>			
				...
				<tr>
					...
					<td>
						<input type="text" id="ds_nlat" name="ds_nlat" value="" />
					</td>
				</tr>	
				...
				<tr>
					...
					<td>
						<input type="text" id="ds_nlon" name="ds_nlon" value="" />
					</td>
				</tr>			
				...
				<tr>
					...
					<td>
						<input type="text" id="ds_nelev" name="ds_nelev" value="" />
					</td>
				</tr>			

				<tr>
					<td><span class="formFont">Horizontal precision of nominal loc:</span></td>
					<td>
						<input type="text" id="ds_herr_loc" name="ds_herr_loc" value="" />
					</td>
				</tr>			
				...
				<tr>
					...
					<td>
						<input type="text" id="ds_stime" name="ds_stime" value="" />
					</td>
				</tr>		
				...
				<tr>
					...
					<td>
						<input type="text" id="ds_stime_unc" name="ds_stime_unc" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="ds_etime" name="ds_etime" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="ds_etime_unc" name="ds_etime_unc" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="ds_utc" name="ds_utc" value="" />
					</td>
				</tr>
				
				<tr>
					<td><span class="formFont">Is it from a reference station?:</span></td>
					<td> 
						<select id="ds_rflag" name="ds_rflag" style='width:200px;color:black;'>
				...
				<tr>
					...
					<td>
						<textarea id="ds_desc" name="ds_desc" cols="30" rows="2" maxlength="255"></textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="ds_ori" name="ds_ori" style='width:200px;color:black;'>
				...
				<tr>
					...
					<td>
						<textarea id="ds_com" name="ds_com" cols="30" rows="2" maxlength="255"></textarea>
					</td>
				</tr>				
...
echo <<<HTMLBLOCK
				...
				<input type="hidden" id="ds_loaddate" name="ds_loaddate" value="" />
				
				<tr>
					<td><span class="formFont">Publish Date:</span></td>
					<td>
						<input type="text" id="ds_pubdate" name="ds_pubdate" value="" />
					</td>
				</tr>
