...
<script language='javascript' type='text/javascript'>
	...
	function getNetwork(val) {
		...
		<h3>Upload online form for seismic station (Table Name: ss) </h3>

		<span> (All fields * are required) </span>
	
		<p class="redtext"><?php if ($error) {print "Registration unsuccessful! Please correct the fields in red:";} ?></p>	
		
		<form method="post" action="insertSwitch.php" name="form_ss" id="form_ss">
...
echo <<<HTMLBLOCK
				...
				<tr>
					...
					<td>
						<select id="sn_id" name="sn_id" style='width:200px;color:black;'>
				...
				<tr>
					...
					<td>
						<input type="text" maxlength="30" id="ss_code" name="ss_code" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" maxlength="30" id="ss_name" name="ss_name" value="" />
					</td>
				</tr>				
				...
				<tr>
					...
					<td>
						<input type="text" id="ss_lat" name="ss_lat" value="" />
					</td>
				</tr>			
				...
				<tr>
					...
					<td>
						<input type="text" id="ss_lon" name="ss_lon" value="" />
					</td>
				</tr>			
				...
				<tr>
					...
					<td>
						<input type="text" id="ss_elev" name="ss_elev" value="" />
					</td>
				</tr>			

				<tr>
					<td><span class="formFont">Instrument Depth:</span></td>
					<td>
						<input type="text" id="ss_depth" name="ss_depth" value="" />
					</td>
				</tr>			
				...
				<tr>
					...
					<td>
						<input type="text" id="ss_stime" name="ss_stime" value="" />
					</td>
				</tr>		
				...
				<tr>
					...
					<td>
						<input type="text" id="ss_stime_unc" name="ss_stime_unc" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="ss_etime" name="ss_etime" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="ss_etime_unc" name="ss_etime_unc" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="ss_utc" name="ss_utc" value="" />
					</td>
				</tr>
				
				<tr>
					<td><span class="formFont">Instrument types:</span></td>
					<td>
						<input type="text" maxlength="255" id="ss_instr_type" name="ss_instr_type" value="" />
					</td>
				</tr>			

				<tr>
					<td><span class="formFont">System gain:</span></td>
					<td>
						<input type="text" id="ss_sgain" name="ss_sgain" value="" />
					</td>
				</tr>			
				...
				<tr>
					...
					<td>
						<textarea id="ss_desc" name="ss_desc" cols="30" rows="2" maxlength="255"></textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="ss_ori" name="ss_ori" style='width:200px;color:black;'>
				...
				<tr>
					...
					<td>
						<textarea id="ss_com" name="ss_com" cols="30" rows="2" maxlength="255"></textarea>
					</td>
				</tr>				
...
echo <<<HTMLBLOCK
				...
				<input type="hidden" id="ss_loaddate" name="ss_loaddate" value="" />
				
				<tr>
					<td><span class="formFont">Publish Date:</span></td>
					<td>
						<input type="text" id="ss_pubdate" name="ss_pubdate" value="" />
					</td>
				</tr>
