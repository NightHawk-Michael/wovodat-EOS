...
<script language='javascript' type='text/javascript'>
	...
	<div class="form">
		...
		<h3>Upload online form for hydrologic station (Table Name: hs) </h3>

		<span> (All fields * are required) </span>
	
		<p class="redtext"><?php if ($error) {print "Registration unsuccessful! Please correct the fields in red:";} ?></p>
		
		<form method="post" action="insertSwitch.php" name="form_hs" id="form_hs">
...
echo <<<HTMLBLOCK
				...
				<tr>
					...
					<td>
						<input type="text" maxlength="30" id="hs_code" name="hs_code" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" maxlength="30" id="hs_name" name="hs_name" value="" />
					</td>
				</tr>				
				...
				<tr>
					...
					<td>
						<input type="text" id="hs_lat" name="hs_lat" value="" />
					</td>
				</tr>	
				...
				<tr>
					...
					<td>
						<input type="text" id="hs_lon" name="hs_lon" value="" />
					</td>
				</tr>			
				...
				<tr>
					...
					<td>
						<input type="text" id="hs_elev" name="hs_elev" value="" />
					</td>
				</tr>			
				...
				<tr>
					...
					<td>
						<input type="text" maxlength="255" id="hs_perm" name="hs_perm" value="" />
					</td>
				</tr>		 
				<tr>
					<td><span class="formFont">Type of water body:</span></td>
					<td>
						<input type="text" maxlength="255" id="hs_type" name="hs_type" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="hs_utc" name="hs_utc" value="" />
					</td>
				</tr>
				
				
				<tr>
					<td><span class="formFont">Top of screen:</span></td>
					<td>
						<input type="text" id="hs_tscr" name="hs_tscr" value="" />
					</td>
				</tr>


				<tr>
					<td><span class="formFont">Bottom of screen:</span></td>
					<td>
						<input type="text" id="hs_bscr" name="hs_bscr" value="" />
					</td>
				</tr>

				<tr>
					<td><span class="formFont">Total depth of well:</span></td>
					<td>
						<input type="text" id="hs_tdepth" name="hs_tdepth" value="" />
					</td>
				</tr>				
				...
				<tr>
					...
					<td>
						<input type="text" id="hs_stime" name="hs_stime" value="" />
					</td>
				</tr>		
				...
				<tr>
					...
					<td>
						<input type="text" id="hs_stime_unc" name="hs_stime_unc" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="hs_etime" name="hs_etime" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="hs_etime_unc" name="hs_etime_unc" value="" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<textarea id="hs_desc" name="hs_desc" cols="30" rows="2" maxlength="255"></textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="hs_ori" name="hs_ori" style='width:200px;color:black;'>
				...
				<tr>
					...
					<td>
						<textarea id="hs_com" name="hs_com" cols="30" rows="2" maxlength="255"></textarea>
					</td>
				</tr>				
...
echo <<<HTMLBLOCK
				...
				<input type="hidden" id="hs_loaddate" name="hs_loaddate" value="" />
				
				<tr>
					<td><span class="formFont">Publish Date:</span></td>
					<td>
						<input type="text" id="hs_pubdate" name="hs_pubdate" value="" />
					</td>
				</tr>
