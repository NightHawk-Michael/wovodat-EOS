...
function getAllResult(){	
	...
	if(isset($_SESSION['sdEvnType']) ||  isset($_SESSION['sdEvnPmag'])  || isset($_SESSION['sdEvnEdepth']) || isset($_SESSION['booleanPostValue']['gd'])) {
/*
...
*/
		...
		if(!isset($_SESSION['sdEvnDistance'])) {
			$_SESSION['sdEvnDistance'] = 30;
		}
		
		
		if(!isset($_SESSION['sdEvnEdepth'] )){
			$_SESSION['sdEvnEdepth'] = " and (TempV1.sd_evn_edep between '-10' and '40') ";  
										// Note use tabel name as 'TempV1' bcoz of different condition
		}		
		
		if(!isset($_SESSION['sdEvnPmag'] )){
			$_SESSION['sdEvnPmag'] = " and (TempV1.sd_evn_pmag between '0' and '9') ";  
										// Note use tabel name as 'TempV1' bcoz of different condition
		}		
/*		
		...
		(SELECT sn_id, sd_evn_eqtype, MIN(sd_evn_time) as MinTime, MAX(sd_evn_time) as MaxTime, sd_evn_elat, sd_evn_elon,sd_evn_edep,sd_evn_pmag FROM sd_evn WHERE sd_evn_pubdate<= now()".$_SESSION['sqlWhereEvn'].$_SESSION['sdEvnType']." group by sn_id, sd_evn_eqtype) AS TempV1,(SELECT vjn.*, vd_inf.vd_inf_slat as vLat, vd_inf.vd_inf_slon as vLon FROM vol_jj_sn as vjn,vd_inf".$_SESSION['sqlFromData']." WHERE vjn.vd_id = vd_inf.vd_id ". $_SESSION['sqlWhereEdTimeData'].$_SESSION['sqlWhereFeature'].$_SESSION['sqlWhereRock'].$_SESSION['sqlWhereVeiData'].$_SESSION['sqlWhereEdPhaseData'].$_SESSION['sqlWhereLat'].$_SESSION['sqlWhereLon'].$_SESSION['sqlWhereElev']." ) AS TempV2 WHERE TempV1.sn_id = TempV2.sn_id and TempV1.MinTime >= DATE_SUB(TempV2.ed_stime, INTERVAL 1 YEAR ) and TempV1.MinTime <= TempV2.ed_stime and ABS( TempV2.vLat - TempV1.sd_evn_elat) < 1 AND ABS( TempV2.vLon - TempV1.sd_evn_elon) < 6 AND (6371*2*ATAN2(SQRT(SIN((RADIANS(TempV1.sd_evn_elat)-RADIANS( TempV2.vLat))/2)*SIN((RADIANS(TempV1.sd_evn_elat)-RADIANS( TempV2.vLat))/2)+SIN((RADIANS(TempV1.sd_evn_elon)-RADIANS( TempV2.vLon))/2)*SIN((RADIANS(TempV1.sd_evn_elon)-RADIANS( TempV2.vLon))/2)*COS(RADIANS( TempV2.vLat))*COS(RADIANS(TempV1.sd_evn_elat))),SQRT(1-(SIN((RADIANS(TempV1.sd_evn_elat)-RADIANS( TempV2.vLat))/2)*SIN((RADIANS(TempV1.sd_evn_elat)-RADIANS( TempV2.vLat))/2)+SIN((RADIANS(TempV1.sd_evn_elon)-RADIANS( TempV2.vLon))/2)*SIN((RADIANS(TempV1.sd_evn_elon)-RADIANS( TempV2.vLon))/2)*COS(RADIANS( TempV2.vLat))*COS(RADIANS(TempV1.sd_evn_elat)))))) < ".$_SESSION['sdEvnDistance'].$_SESSION['sdEvnEdepth'].$_SESSION['sdEvnPmag']." GROUP BY TempV2.vd_name, TempV2.vd_id, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei, TempV1.sd_evn_eqtype union ";
		

	 

		$sql .= "SELECT distinct TempV2.vd_name AS vdName, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei, concat('Network Events(', TempV1.sd_evn_eqtype, ')'),TempV1.MinTime, TempV1.MaxTime, concat('vnum=', TempV2.vd_num),TempV2.sn_id as n_id,concat('sdEvn') as dataType FROM (SELECT sn_id, sd_evn_eqtype, MIN(sd_evn_time) as MinTime, MAX(sd_evn_time) as MaxTime, sd_evn_elat, sd_evn_elon,sd_evn_edep,sd_evn_pmag FROM sd_evn WHERE sd_evn_pubdate<= now()".$_SESSION['sqlWhereEvn'].$_SESSION['sdEvnType']." group by sn_id, sd_evn_eqtype) AS TempV1,(SELECT vjn.*, vd_inf.vd_inf_slat as vLat, vd_inf.vd_inf_slon as vLon FROM vol_jj_sn as vjn,vd_inf".$_SESSION['sqlFromData']." WHERE vjn.vd_id = vd_inf.vd_id ". $_SESSION['sqlWhereEdTimeData'].$_SESSION['sqlWhereFeature'].$_SESSION['sqlWhereRock'].$_SESSION['sqlWhereVeiData'].$_SESSION['sqlWhereEdPhaseData'].$_SESSION['sqlWhereLat'].$_SESSION['sqlWhereLon'].$_SESSION['sqlWhereElev']." ) AS TempV2 WHERE 
		 TempV1.sn_id = TempV2.sn_id and TempV1.MinTime >= DATE_SUB(TempV2.ed_stime, INTERVAL 1 YEAR ) and TempV1.MinTime <= TempV2.ed_stime".$_SESSION['sdEvnEdepth'].$_SESSION['sdEvnPmag']." GROUP BY TempV2.vd_name, TempV2.vd_id, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei, TempV1.sd_evn_eqtype union ";
*/	

		$sql .= "SELECT distinct TempV2.vd_name AS vdName, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei, concat('Network Events(', TempV1.sd_evn_eqtype, ')'),
		
		DATE_SUB(TempV2.ed_stime, INTERVAL 1 YEAR ) , 
		
		DATE_ADD(TempV2.ed_stime, INTERVAL 1 YEAR ), 
		
		
		concat('vnum=', TempV2.vd_num),TempV2.sn_id as n_id,concat('sdEvn') as dataType FROM (SELECT sn_id, sd_evn_eqtype, MIN(sd_evn_time) as MinTime, MAX(sd_evn_time) as MaxTime, sd_evn_elat, sd_evn_elon,sd_evn_edep,sd_evn_pmag FROM sd_evn WHERE sd_evn_pubdate<= now()".$_SESSION['sqlWhereEvn'].$_SESSION['sdEvnType']." group by sn_id, sd_evn_eqtype) AS TempV1,(SELECT vjn.*, vd_inf.vd_inf_slat as vLat, vd_inf.vd_inf_slon as vLon FROM vol_jj_sn as vjn,vd_inf".$_SESSION['sqlFromData']." WHERE vjn.vd_id = vd_inf.vd_id ". $_SESSION['sqlWhereEdTimeData'].$_SESSION['sqlWhereFeature'].$_SESSION['sqlWhereRock'].$_SESSION['sqlWhereVeiData'].$_SESSION['sqlWhereEdPhaseData'].$_SESSION['sqlWhereLat'].$_SESSION['sqlWhereLon'].$_SESSION['sqlWhereElev']." ) AS TempV2 WHERE 
		 TempV1.sn_id = TempV2.sn_id and TempV2.ed_stime <> '0000-00-00 00:00:00' 
		 
		 and TempV1.MinTime >= DATE_SUB(TempV2.ed_stime, INTERVAL 1 YEAR ) and TempV1.MinTime <= DATE_ADD(TempV2.ed_stime, INTERVAL 1 YEAR ) 
		 
		 
		 ".$_SESSION['sdEvnEdepth'].$_SESSION['sdEvnPmag']." GROUP BY TempV2.vd_name, TempV2.vd_id, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei, TempV1.sd_evn_eqtype union ";
	}   
	...
	if(isset($_SESSION['sdEvsType'])) {  
		...
		FROM (SELECT ss_id,sd_evs_eqtype,MIN(sd_evs_time) as MinTime, MAX(sd_evs_time) as MaxTime FROM sd_evs WHERE sd_evs_pubdate<= now() and". $_SESSION['sqlWhereEvs'].$_SESSION['sdEvsType']." group by ss_id, sd_evs_eqtype) AS TempV1,(SELECT vjn.*,ss.ss_id FROM vol_jj_sn as vjn,ss".$_SESSION['sqlFromData']." WHERE vjn.sn_id=ss.sn_id ". $_SESSION['sqlWhereEdTimeData'].$_SESSION['sqlWhereFeature'].$_SESSION['sqlWhereRock'].$_SESSION['sqlWhereVeiData'].
		$_SESSION['sqlWhereEdPhaseData'].$_SESSION['sqlWhereLat'].$_SESSION['sqlWhereLon'].$_SESSION['sqlWhereElev'].") AS TempV2 WHERE TempV1.ss_id = TempV2.ss_id and TempV1.MinTime >= DATE_SUB(TempV2.ed_stime, INTERVAL 1 YEAR ) and TempV1.MinTime <= TempV2.ed_stime GROUP BY TempV2.vd_name, TempV2.vd_id, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei, TempV1.sd_evs_eqtype union ";
...
*/
		...
		$sql .="SELECT distinct TempV2.vd_name AS vdName, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei, concat('Intensity'),TempV1.MinTime, TempV1.MaxTime, concat('vnum=', TempV2.vd_num),TempV2.sn_id as n_id,concat('Intensity') as dataType 
		FROM (SELECT vd_id, MIN(sd_int_time) as MinTime, MAX(sd_int_time) as MaxTime FROM sd_int WHERE sd_int_pubdate<= now()) AS TempV1,
		
		(SELECT vjn.* FROM vol_jj_sn as vjn".$_SESSION['sqlFromData']." WHERE vjn.sn_id IS NOT NULL ". $_SESSION['sqlWhereEdTimeData'].$_SESSION['sqlWhereFeature'].$_SESSION['sqlWhereRock'].$_SESSION['sqlWhereVeiData'].$_SESSION['sqlWhereEdPhaseData'].$_SESSION['sqlWhereLat'].$_SESSION['sqlWhereLon'].$_SESSION['sqlWhereElev'].") AS TempV2 WHERE TempV1.vd_id = TempV2.vd_id and TempV1.MinTime >= DATE_SUB(TempV2.ed_stime, INTERVAL 1 YEAR ) and TempV1.MinTime <= TempV2.ed_stime GROUP BY TempV2.vd_name, TempV2.vd_id, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei union ";
	}   
	...
	if(isset($_SESSION['sqlWhereAng'])) {
		...
		$sql .= "SELECT distinct TempV2.vd_name AS vdName, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei, concat('Angle'),TempV1.MinTime, TempV1.MaxTime,  concat('vnum=', TempV2.vd_num),TempV2.cn_id as n_id,concat('Angle') as dataType FROM (SELECT distinct ds_id,ds_id1,ds_id2, MIN(dd_ang_time) as MinTime, MAX(dd_ang_time) as MaxTime FROM dd_ang WHERE dd_ang_pubdate<= now() and". $_SESSION['sqlWhereAng']." group by ds_id,ds_id1,ds_id2) AS TempV1,(SELECT vjn.*,ds.ds_id FROM vol_jj_cn as vjn,ds".$_SESSION['sqlFromData']." WHERE vjn.cn_id=ds.cn_id and (vjn.cn_type='Deformation' || vjn.cn_type='C') ". $_SESSION['sqlWhereEdTimeData'].$_SESSION['sqlWhereFeature'].$_SESSION['sqlWhereRock'].$_SESSION['sqlWhereVeiData'].$_SESSION['sqlWhereEdPhaseData'].$_SESSION['sqlWhereLat'].$_SESSION['sqlWhereLon'].$_SESSION['sqlWhereElev'].") AS TempV2 WHERE (TempV1.ds_id = TempV2.ds_id || TempV1.ds_id1 = TempV2.ds_id || TempV1.ds_id2 = TempV2.ds_id) and TempV1.MinTime >= DATE_SUB(TempV2.ed_stime, INTERVAL 1 YEAR ) and TempV1.MinTime <= TempV2.ed_stime GROUP BY TempV2.vd_name, TempV2.vd_id, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei union "; 		
...
//	if(isset($_SESSION['gdSpecies'])) {
	if(isset($_SESSION['gdSpecies']) || isset($_SESSION['booleanPostValue']['gd'])) { 
		...
		WHERE gd_pubdate<= now()".$_SESSION['sqlWhereGd'].$_SESSION['gdSpecies']." group by gs_id) AS TempV1,(SELECT vjn.*,gs.gs_id FROM vol_jj_cn as vjn,gs".$_SESSION['sqlFromData']." WHERE vjn.cn_id=gs.cn_id and (vjn.cn_type='Gas' || vjn.cn_type='C') ".$_SESSION['sqlWhereEdTimeData'].$_SESSION['sqlWhereFeature'].$_SESSION['sqlWhereRock'].$_SESSION['sqlWhereVeiData'].$_SESSION['sqlWhereEdPhaseData'].$_SESSION['sqlWhereLat'].$_SESSION['sqlWhereLon'].$_SESSION['sqlWhereElev'].$_SESSION['sqlWhereLat'].$_SESSION['sqlWhereLon'].$_SESSION['sqlWhereElev']." ) AS TempV2 WHERE TempV1.gs_id = TempV2.gs_id and TempV1.MinTime >= DATE_SUB(TempV2.ed_stime, INTERVAL 1 YEAR ) and TempV1.MinTime <= TempV2.ed_stime GROUP BY TempV2.vd_name, TempV2.vd_id, TempV2.vd_inf_type, TempV2.vd_inf_rtype, TempV2.ed_stime, TempV2.ed_etime, TempV2.ed_vei union "; 	

	}

//	if(isset($_SESSION['gdPluSpecies'])) {
	if(isset($_SESSION['gdPluSpecies']) || isset($_SESSION['booleanPostValue']['gd_plu'])) {
	/* Ground based plume & Satellite plume   */
		...
		TempV1.MinTime, TempV1.MaxTime,concat('vnum=', TempV2.vd_num),TempV1.cs_id as n_id,concat('Plume from Satellite') as dataType FROM 
		...
		(SELECT vjn.* FROM vol_jj_cn as vjn,gs".$_SESSION['sqlFromData']." WHERE (vjn.cn_type='Gas' || vjn.cn_type='C') ". $_SESSION['sqlWhereEdTimeData'].$_SESSION['sqlWhereFeature'].$_SESSION['sqlWhereRock'].$_SESSION['sqlWhereVeiData'].
		$_SESSION['sqlWhereEdPhaseData'].$_SESSION['sqlWhereLat'].$_SESSION['sqlWhereLon'].$_SESSION['sqlWhereElev'].") AS TempV2 
...
//	if(isset($_SESSION['gdSolSpecies'])) {
	if(isset($_SESSION['gdSolSpecies']) || isset($_SESSION['booleanPostValue']['gd_sol'])) {	
