define(function (require) {
    ...
    return Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            this.urlFilter = options.selectedFilters;
        ...
        showGraph: function (event) {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                ...
                if (checkbox.id.split(".")[1] == this.urlFilter) {
                    checkbox.checked = true;
                }
                if (checkbox.checked) {
                    var temp = checkbox.id.split(".");
                    if(!this.selectingFilters.includes(checkbox.id)){
                        this.selectingFilters.push(checkbox.id);
                    }
                }else{
                    if(this.selectingFilters.includes(checkbox.id)){
                        this.selectingFilters.push(checkbox.id);
