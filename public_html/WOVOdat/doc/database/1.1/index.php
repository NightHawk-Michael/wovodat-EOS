...
#content_ref_top{width:860px; height:10px; float:left; overflow:auto; padding:0px 30px 0px 30px;}
...
ul.table_list_table li {
    margin-top: 5px;
}

ul.table_list_table a {
...
<div class="body">
			...
			<div id="main_content">
				...
				<p>An offline version of this documentation is available <a href="/doc/database/1.1/wovodat11_doc.pdf">here</a>.</p>
