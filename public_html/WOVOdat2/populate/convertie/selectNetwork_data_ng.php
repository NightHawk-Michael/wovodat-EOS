...
if($stationdisplay == "EventDataFromNetwork" || $stationdisplay=="SeismicTremor" || $stationdisplay=="IntervalSwarmData"){
	...
	if (! mysql_num_rows($result)){      // if (false)
		$result= mysql_query("SELECT a.sn_name,a.sn_code	FROM sn a, vd b, jj_volnet c WHERE  c.jj_net_flag='S' and c.jj_net_id=a.sn_id and c.vd_id=b.vd_id and b.vd_name='$volca'")or die(mysql_error());
	}
