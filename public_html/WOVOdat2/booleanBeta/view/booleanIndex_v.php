	...
	<form id="boolean_form" name="boolean_form" method="post" action="">
		<div id="mainCategory container">
			...
			<div id="Volcano_Search" class = "  row" data-collapsible="expandable">
                <button class="btn btn-primary left-align col s3 offset-s1 " type="button" data-toggle="collapse" data-target="#Volcano_Inner_Group">Volcano Search
			...
			<div id="Eruption_Search" class = "row">
				<button class="btn btn-primary left-align col s3 offset-s1" type="button" data-toggle="collapse" data-target="#Eruption_Inner_Group">Eruption Search
					<i class="material-icons right">send</i>
				</button>
			...
			<div id="Monitoring_Data_Search" class="row">
                <button class="btn btn-primary left-align col s3 offset-s1" type="button" data-toggle="collapse" data-target="#Collapse">Monitoring Data Search
                    <i class="material-icons right">send</i>
                </button>
