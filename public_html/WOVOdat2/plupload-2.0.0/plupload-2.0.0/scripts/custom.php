...
<script type="text/javascript" src="../../plupload-2.0.0/plupload-2.0.0/js/jquery.plupload.queue.min.js"></script>
...
<form id="{$_SESSION['imageName']}" method="post" action="#">
