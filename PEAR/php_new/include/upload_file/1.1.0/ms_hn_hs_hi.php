...
if ($id==NULL) {
	...
	$field_value[10]=xml_get_ele($ms_hn_hs_hi_obj, "DESCRIPTION");     // Nang added on  17-Sep-2012	
	$field_value[11]=xml_get_ele($ms_hn_hs_hi_obj, "ORGDIGITIZE");     // Nang added on  17-Sep-2012	
	$field_value[12]=xml_get_ele($ms_hn_hs_hi_obj, "COMMENTS");	       // Nang added on  17-Sep-2012	
