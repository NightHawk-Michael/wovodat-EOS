...
if ($id==NULL) {
	...
	$field_name[16]="hs_ori";             // Nang added on  17-Sep-2012
	$field_name[17]="hs_com";             // Nang added on  17-Sep-2012
	$field_name[18]="cn_id";
	$field_name[19]="cc_id";
	...
	$field_value[16]=xml_get_ele($ms_hn_hs_obj, "ORGDIGITIZE");          // Nang added on  17-Sep-2012	
	$field_value[17]=xml_get_ele($ms_hn_hs_obj, "COMMENTS");             // Nang added on  17-Sep-2012	
