...
if ($id==NULL) {
	...
	$field_name[25]="sd_ivl_fmin";          // Nang added on 19-Sep-2012		         
	$field_name[26]="sd_ivl_fmax";          // Nang added on 19-Sep-2012	
	$field_name[27]="sd_ivl_amin";          // Nang added on 19-Sep-2012	
	$field_name[28]="sd_ivl_amax";          // Nang added on 19-Sep-2012	
	$field_name[29]="sd_ivl_desc";
	$field_name[30]="sd_ivl_ori";          // Nang added on 19-Sep-2012	
	$field_name[31]="sd_ivl_com";          // Nang added on 19-Sep-2012	
	$field_name[32]="sn_id";
	$field_name[33]="ss_id";
	$field_name[34]="cc_id";
	...
	$field_value[25]=xml_get_ele($da_sd_ivl_ivl_obj, "MINFREQUENCY");          // Nang added on 19-Sep-2012	
	$field_value[26]=xml_get_ele($da_sd_ivl_ivl_obj, "MAXFREQUENCY");          // Nang added on 19-Sep-2012	
	$field_value[27]=xml_get_ele($da_sd_ivl_ivl_obj, "MINAMPLITUDE");          // Nang added on 19-Sep-2012	
	$field_value[28]=xml_get_ele($da_sd_ivl_ivl_obj, "MAXAMPLITUDE");          // Nang added on 19-Sep-2012		
	$field_value[29]=xml_get_ele($da_sd_ivl_ivl_obj, "DESCRIPTION");
	$field_value[30]=xml_get_ele($da_sd_ivl_ivl_obj, "ORGDIGITIZE");          // Nang added on 19-Sep-2012	
	$field_value[31]=xml_get_ele($da_sd_ivl_ivl_obj, "COMMENTS");	          // Nang added on 19-Sep-2012	
