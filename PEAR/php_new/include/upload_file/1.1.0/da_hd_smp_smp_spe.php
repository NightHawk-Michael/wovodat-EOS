...
if ($id==NULL) {
	...
	$field_name[20]="hd_atemp";           // Nang added on  17-Sep-2012	
	$field_name[21]="hd_tds";             // Nang added on  17-Sep-2012	
	$field_name[22]="hd_ori";	          // Nang added on  17-Sep-2012	 
	...
	$field_value[20]=xml_get_ele($da_hd_smp_smp_obj, "AIRTEMP");	            // Nang added on  17-Sep-2012	
	$field_value[21]=xml_get_ele($da_hd_smp_smp_obj, "TOTALDISOLVEDSOLID");     // Nang added on  17-Sep-2012	
	$field_value[22]=xml_get_ele($da_hd_smp_smp_obj, "ORGDIGITIZE");            // Nang added on  17-Sep-2012	
...
// Else, UPDATE
	...
	$field_name[19]="hd_atemp";           // Nang added on  17-Sep-2012	
	$field_name[20]="hd_tds";             // Nang added on  17-Sep-2012	
	$field_name[21]="hd_ori";	          // Nang added on  17-Sep-2012	 	
	...
	$field_value[19]=xml_get_ele($da_hd_smp_smp_obj, "AIRTEMP");	            // Nang added on  17-Sep-2012	
	$field_value[20]=xml_get_ele($da_hd_smp_smp_obj, "TOTALDISOLVEDSOLID");     // Nang added on  17-Sep-2012	
	$field_value[21]=xml_get_ele($da_hd_smp_smp_obj, "ORGDIGITIZE");            // Nang added on  17-Sep-2012		
