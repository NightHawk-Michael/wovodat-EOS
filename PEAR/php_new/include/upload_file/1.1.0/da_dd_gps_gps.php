...
if ($id==NULL) {
	...
	$field_name[13]="dd_gps_slope";       //Nang added on 29-Aug-2013
	$field_name[14]="dd_gps_errslope";    //Nang added on 29-Aug-2013
	$field_name[15]="dd_gps_ori";         //Nang added on 07-Sep-2012	
	$field_name[16]="dd_gps_com";         //Nang added on 07-Sep-2012	
	$field_name[17]="ds_id";
	$field_name[18]="ds_id_ref1";
	$field_name[19]="ds_id_ref2";
	$field_name[20]="di_gen_id";
	$field_name[21]="cc_id";
	$field_name[22]="cc_id2";
	$field_name[23]="cc_id3";
	$field_name[24]="dd_gps_pubdate";
	$field_name[25]="cc_id_load";
	$field_name[26]="dd_gps_loaddate";
	...
	$field_value[13]=xml_get_ele($da_dd_gps_gps_obj, "SLOPE");	         //Nang added on 29-Aug-2013	
	$field_value[14]=xml_get_ele($da_dd_gps_gps_obj, "ERRSLOPE");	     //Nang added on 29-Aug-2013		
	$field_value[15]=xml_get_ele($da_dd_gps_gps_obj, "ORGDIGITIZE");	 //Nang added on 07-Sep-2012	
	$field_value[16]=xml_get_ele($da_dd_gps_gps_obj, "COMMENTS");	     //Nang added on 07-Sep-2012	
	$field_value[17]=$ds_id;
	$field_value[18]=$ds_id_ref1;
	$field_value[19]=$ds_id_ref2;
	$field_value[20]=$di_gen_id;
	$field_value[21]=$da_dd_gps_gps_obj['results']['owners'][0]['id'];
	$field_value[22]=$da_dd_gps_gps_obj['results']['owners'][1]['id'];
	$field_value[23]=$da_dd_gps_gps_obj['results']['owners'][2]['id'];
	$field_value[24]=$da_dd_gps_gps_obj['results']['pubdate'];
