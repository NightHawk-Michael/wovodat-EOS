...
foreach ($ms_obj['value'] as &$ms_ele) {
	switch ($ms_ele['tag']) {
		case "AIRPLANE":
			...
			break; 
		case "SATELLITE":             // Nang added on 5-June-2102 
		...
		case "THERMALINSTRUMENTS":
			...
			break;
		case "METEONETWORK":        // Nang added on 14-May-2102 
			$ms_mn_obj=&$ms_ele;
			include "ms_mn.php";
			if (!empty($errors)) {
				return FALSE;
			...
			break;
		case "METEOSTATIONS":       // Nang added on 14-May-2102 
			$ms_ms_obj=&$ms_ele;
			include "ms_ms.php";
			if (!empty($errors)) {
				return FALSE;
			...
			break;
		case "METEOINSTRUMENTS":   // Nang added on 14-May-2102 
			$ms_mi_obj=&$ms_ele;
			include "ms_mi.php";
			if (!empty($errors)) {
				return FALSE;
