...
/*    Nang Added from line 65-105   on 16-Mar-2012  */
// ^^^ Get satellite. From xml always comes "satellite". Actually this script is able to get cs_id for both A/S. But dd-sar only needs satellite so this scripts assume to get only satellite.
...
// ### Check necessary information: instrument or satellite... Currently xml don't have instr id coz assumed that there is no instr for this moment.  
...
/* Nang added line from 65-104  on 16-Mar-2012 */
...
$data['di_gen_id']=$da_dd_sar_sar_obj['results']['di_gen_id'];   //Nang added on 19-Mar-2012
$data['cs_id']=$da_dd_sar_sar_obj['results']['cs_id'];           //Nang added on 19-Mar-2012 
...
array_shift($gen_stations2);       //Nang added on 19-Mar-2012
?>