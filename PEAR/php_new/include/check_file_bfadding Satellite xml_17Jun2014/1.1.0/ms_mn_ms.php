...
// store $table_key... "cn" from ms_mn.php as $pr_table used for limit searching of duplicate stations
...
//if (!v1_check_db_timeframe($ms_mn_ms_name, $ms_mn_ms_key, $code, $ms_mn_ms_stime, $ms_mn_ms_etime, $final_owners, $check_db_error)) {
