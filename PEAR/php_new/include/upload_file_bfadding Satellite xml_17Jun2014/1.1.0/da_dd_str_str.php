...
if ($id==NULL) {
	...
	$field_name[30]="dd_str_bpres";	          //Nang added on 17-Feb-2014
	$field_name[31]="dd_str_ori";             //Nang added on 12-Sep-2012		
	$field_name[32]="dd_str_com";
	$field_name[33]="ds_id";
	$field_name[34]="di_tlt_id";
	$field_name[35]="cc_id";
	$field_name[36]="cc_id2";
	$field_name[37]="cc_id3";
	$field_name[38]="dd_str_pubdate";
	$field_name[39]="cc_id_load";
	$field_name[40]="dd_str_loaddate";
	...
	$field_value[30]=xml_get_ele($da_dd_str_str_obj, "BARPRESS");      //Nang added on 17-Feb-2014
	$field_value[31]=xml_get_ele($da_dd_str_str_obj, "ORGDIGITIZE");   //Nang added on 12-Sep-2012
	$field_value[32]=xml_get_ele($da_dd_str_str_obj, "COMMENTS");
	$field_value[33]=$ds_id;
	$field_value[34]=$di_tlt_id;
	$field_value[35]=$da_dd_str_str_obj['results']['owners'][0]['id'];
	$field_value[36]=$da_dd_str_str_obj['results']['owners'][1]['id'];
	$field_value[37]=$da_dd_str_str_obj['results']['owners'][2]['id'];
	$field_value[38]=$da_dd_str_str_obj['results']['pubdate'];
	$field_value[39]=$cc_id_load;
	$field_value[40]=$current_time;
