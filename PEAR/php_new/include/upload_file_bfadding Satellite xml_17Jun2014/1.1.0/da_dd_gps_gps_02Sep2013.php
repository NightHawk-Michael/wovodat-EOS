...
if ($id==NULL) {
	...
	$field_name[13]="dd_gps_ori";    //Nang added on 07-Sep-2012	
	$field_name[14]="dd_gps_com";    //Nang added on 07-Sep-2012	
	$field_name[15]="ds_id";
	...
	$field_value[13]=xml_get_ele($da_dd_gps_gps_obj, "ORGDIGITIZE");	 //Nang added on 07-Sep-2012	
	$field_value[14]=xml_get_ele($da_dd_gps_gps_obj, "COMMENTS");	     //Nang added on 07-Sep-2012	
