...
// Prepare link to cs_id      Nang added on 19-Mar-2012
...
if ($id==NULL) {
	...
	$field_name[22]="dd_sar_img_path";        //Nang added on 11-Sep-2012	
	$field_name[23]="dd_sar_geotiff";         //Nang added on 11-Sep-2012	
	$field_name[24]="dd_sar_prometh";
	$field_name[25]="dd_sar_softwr";
	$field_name[26]="dd_sar_dem_qual";
	$field_name[27]="dd_sar_ori";            //Nang added on 11-Sep-2012	
	$field_name[28]="dd_sar_com";            //Nang added on 11-Sep-2012	
	...
	$field_name[38]="cs_id";   // Nang added on 19-Mar-2012		
	$field_value=array();
	$field_value[0]=$code;
	...
	$field_value[22]=xml_get_ele($da_dd_sar_sar_obj, "IMAGEPATH");     //Nang added on 11-Sep-2012		
	$field_value[23]=xml_get_ele($da_dd_sar_sar_obj, "GEOTIFF");       //Nang added on 11-Sep-2012		
	...
	$field_value[27]=xml_get_ele($da_dd_sar_sar_obj, "ORGDIGITIZE");   //Nang added on 11-Sep-2012		
	$field_value[28]=xml_get_ele($da_dd_sar_sar_obj, "COMMENTS");      //Nang added on 11-Sep-2012		
	...
	$field_value[38]=$cs_id;  // Nang added on 19-Mar-2012	
...
// Else, UPDATE
	...
	$field_name[35]="cs_id";  // Nang added on 19-Mar-2012	
	$field_value=array();
	...
	$field_value[35]=$cs_id;    // Nang added on 19-Mar-2012	
