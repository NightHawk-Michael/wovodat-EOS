...
if ($id==NULL) {
	...
	$field_name[11]="dd_tlt_temp";        //Nang added on 13-Sep-2012
	$field_name[12]="dd_tlt_bat";         //Nang added on 13-Sep-2012
	$field_name[13]="dd_tlt_ori";         //Nang added on 13-Sep-2012
	$field_name[14]="dd_tlt_com";         //Nang added on 13-Sep-2012   
	$field_name[15]="ds_id";
	...
	$field_value[2]=xml_get_ele($da_dd_tlt_tlt_obj, "MEASTIMECSEC");	 // changed on 21-Feb-2013 
	$field_value[3]=$da_dd_tlt_tlt_obj['results']['dd_tlt_time_unc'];	
	$field_value[4]=xml_get_ele($da_dd_tlt_tlt_obj, "MEASTIMECSECUNC");	 // changed on 21-Feb-2013  	
	...
	$field_value[11]=xml_get_ele($da_dd_tlt_tlt_obj, "TEMPERATURE");     //Nang added on 13-Sep-2012
	$field_value[12]=xml_get_ele($da_dd_tlt_tlt_obj, "BATTERY");         //Nang added on 13-Sep-2012
	$field_value[13]=xml_get_ele($da_dd_tlt_tlt_obj, "ORGDIGITIZE");     //Nang added on 13-Sep-2012
	$field_value[14]=xml_get_ele($da_dd_tlt_tlt_obj, "COMMENTS");        //Nang added on 13-Sep-2012
