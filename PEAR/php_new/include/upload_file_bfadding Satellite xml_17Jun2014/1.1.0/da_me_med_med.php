...
if ($id==NULL) {
	...
	$field_name[10]="med_wsmin";           // Nang added on  17-Sep-2012	
	$field_name[11]="med_wsmax";	       // Nang added on  17-Sep-2012	
	...
	$field_value[10]=xml_get_ele($da_me_med_med_obj, "MINWINDSPEED");    // Nang added on  17-Sep-2012	
	$field_value[11]=xml_get_ele($da_me_med_med_obj, "MAXWINDSPEED");    // Nang added on  17-Sep-2012	
