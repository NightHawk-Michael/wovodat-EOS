...
if ($id==NULL) {
	...
	$field_name[2]="dd_srd_com";     //Nang added on 11-Sep-2012	
	...
	$field_value[2]=xml_get_ele($da_dd_srd_srd_obj, "COMMENTS");     //Nang added on 11-Sep-2012	
...
// Else, UPDATE
	...
	$field_name[1]="dd_srd_com";     //Nang added on 11-Sep-2012	
	$field_value=array();
	$field_value[0]=xml_get_ele($da_dd_srd_srd_obj, "RANGEOFCHANGE");
	$field_value[1]=xml_get_ele($da_dd_srd_srd_obj, "COMMENTS");     //Nang added on 11-Sep-2012		
