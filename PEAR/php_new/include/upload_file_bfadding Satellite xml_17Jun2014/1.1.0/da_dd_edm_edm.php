...
if ($id==NULL) {
	...
	$field_name[6]="dd_edm_ori";   //Nang added on 07-Sep-2012	
	$field_name[7]="dd_edm_com";   //Nang added on 07-Sep-2012	
	$field_name[8]="ds_id1";
	$field_name[9]="ds_id2";
	...
	$field_value[6]=xml_get_ele($da_dd_edm_edm_obj, "ORGDIGITIZE");  //Nang added on 07-Sep-2012	
	$field_value[7]=xml_get_ele($da_dd_edm_edm_obj, "COMMENTS");	 //Nang added on 07-Sep-2012	
