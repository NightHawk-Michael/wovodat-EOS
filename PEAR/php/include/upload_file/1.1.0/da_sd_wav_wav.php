...
if ($id==NULL) {
	...
	$field_name[7]="sd_wav_ori";	 // Nang added on 19-Sep-2012		
	$field_name[8]="sd_wav_com";     // Nang added on 19-Sep-2012	
	$field_name[9]="ss_id";
	...
	$field_value[7]=xml_get_ele($da_sd_wav_wav_obj, "ORGDIGITIZE");           // Nang added on 19-Sep-2012	
	$field_value[8]=xml_get_ele($da_sd_wav_wav_obj, "COMMENTS");	          // Nang added on 19-Sep-2012	
	$field_value[9]=$ss_id;
