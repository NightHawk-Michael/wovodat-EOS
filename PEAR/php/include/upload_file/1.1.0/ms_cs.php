...
if ($id==NULL) {
	...
	$field_name[10]="cs_ori";	          //Nang added on 07-Sep-2012
	...
	$field_value[7]=xml_get_ele($ms_cs_obj, "OTYPE");              //Nang added on 02-Dec-2014
	$field_value[8]=xml_get_ele($ms_cs_obj, "OHEIGHT");            //Nang added on 02-Dec-2014
	$field_value[9]=xml_get_ele($ms_cs_obj, "DESCRIPTION");
	$field_value[10]=xml_get_ele($ms_cs_obj, "ORGDIGITIZE");	   //Nang added on 07-Sep-2012
	$field_value[11]=xml_get_ele($ms_cs_obj, "COMMENTS");	
	$field_value[12]=$ms_cs_obj['results']['owners'][0]['id'];
	$field_value[13]=$ms_cs_obj['results']['owners'][1]['id'];
	$field_value[14]=$ms_cs_obj['results']['owners'][2]['id'];
	$field_value[15]=$current_time;
	$field_value[16]=$ms_cs_obj['results']['pubdate'];
...
// Else, UPDATE
	...
	$field_name[8]="cs_ori";	       //Nang added on 07-Sep-2012
	$field_name[9]="cs_com";	
	$field_name[10]="cc_id";
	...
	$field_value[5]=xml_get_ele($ms_cs_obj, "OTYPE");           //Nang added on 02-Dec-2014
	$field_value[6]=xml_get_ele($ms_cs_obj, "OHEIGHT");         //Nang added on 02-Dec-2014	
	$field_value[7]=xml_get_ele($ms_cs_obj, "DESCRIPTION");
	$field_value[8]=xml_get_ele($ms_cs_obj, "ORGDIGITIZE");	         //Nang added on 07-Sep-2012
