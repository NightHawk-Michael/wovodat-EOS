...
if ($id==NULL) {
	...
	$field_value[19]=xml_get_ele($ms_sc_sc_obj,  "ORGDIGITIZE");	          // Nang added on 19-Sep-2012	
...
// Else, UPDATE
	...
	$field_value[16]=xml_get_ele($ms_sc_sc_obj,  "ORGDIGITIZE");	          // Nang added on 19-Sep-2012		
