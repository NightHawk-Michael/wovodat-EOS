...
if ($id==NULL) {
	...
	$field_name[10]="gd_sol_units";	 // Nang added on 17-Sep-2012
	$field_name[11]="gd_sol_ori";    // Nang added on 08-May-2012
	...
	$field_value[10]=xml_get_ele($da_gd_sol_sol_obj, "REPORTEDUNITS");	 // Nang added on  17-Sep-2012
	$field_value[11]=xml_get_ele($da_gd_sol_sol_obj, "ORGDIGITIZE");	 // Nang added on 08-May-2012
