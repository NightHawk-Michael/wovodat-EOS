...
if ($id==NULL) {
	...
	$field_name[13]="sd_evs_domFre";                    //Nang added on 09-Sep-2013	
	$field_name[14]="sd_evs_firMotion";                 //Nang added on 09-Sep-2013	
	$field_name[15]="sd_evs_mag";                       //Nang added on 30-Aug-2013	
	$field_name[16]="sd_evs_energy";                    //Nang added on 30-Aug-2013	
	$field_name[17]="sd_evs_ori";                       //  Nang added on 19-Sep-2012
	$field_name[18]="sd_evs_com";                       //  Nang added on 19-Sep-2012
	$field_name[19]="ss_id";
	$field_name[20]="cc_id";
	$field_name[21]="cc_id2";
	$field_name[22]="cc_id3";
	$field_name[23]="sd_evs_pubdate";
	$field_name[24]="cc_id_load";
	$field_name[25]="sd_evs_loaddate";
	$field_name[26]="cb_ids";	

	$field_value=array();
	$field_value[0]=$code;
	$field_value[1]=$da_sd_evs_evs_obj['results']['sd_evs_time'];
	$field_value[2]=xml_get_ele($da_sd_evs_evs_obj, "STARTTIMECSEC");        // changed on 21-Feb-2013  
	$field_value[3]=$da_sd_evs_evs_obj['results']['sd_evs_time_unc'];	
	$field_value[4]=xml_get_ele($da_sd_evs_evs_obj, "STARTTIMECSECUNC");     // changed on 21-Feb-2013  
	...
	$field_value[13]=xml_get_ele($da_sd_evs_evs_obj, "DOMFREQUENCY");         //Nang added on 09-Sep-2013
	$field_value[14]=xml_get_ele($da_sd_evs_evs_obj, "FIRSTMOTION");          //Nang added on 09-Sep-2013
	$field_value[15]=xml_get_ele($da_sd_evs_evs_obj, "MAGNITUDE");            //Nang added on 30-Aug-2013	
	$field_value[16]=xml_get_ele($da_sd_evs_evs_obj, "ENERGY");               //Nang added on 30-Aug-2013	
	$field_value[17]=xml_get_ele($da_sd_evs_evs_obj, "ORGDIGITIZE");          // Nang added on 19-Sep-2012	
	$field_value[18]=xml_get_ele($da_sd_evs_evs_obj, "COMMENTS");	          // Nang added on 19-Sep-2012	
	$field_value[19]=$ss_id;
	$field_value[20]=$da_sd_evs_evs_obj['results']['owners'][0]['id'];
	$field_value[21]=$da_sd_evs_evs_obj['results']['owners'][1]['id'];
	$field_value[22]=$da_sd_evs_evs_obj['results']['owners'][2]['id'];
	$field_value[23]=$da_sd_evs_evs_obj['results']['pubdate'];
