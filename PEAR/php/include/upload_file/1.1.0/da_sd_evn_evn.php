...
if ($id==NULL) {
	...
	$field_name[56]="sd_evn_foc";            // Nang added on  19-Sep-2012
	$field_name[57]="sd_evn_ori";	         // Nang added on  19-Sep-2012
	...
	$field_value[3]=xml_get_ele($da_sd_evn_evn_obj, "ORIGINTIMECSEC");      //Nang Changed on 21-Feb-2013	
	$field_value[4]=$da_sd_evn_evn_obj['results']['sd_evn_time_unc'];
	$field_value[5]=xml_get_ele($da_sd_evn_evn_obj, "ORIGINTIMECSECUNC");	//Nang Changed on 21-Feb-2013
	...
	$field_value[56]=xml_get_ele($da_sd_evn_evn_obj, "FOCALPLANESOL");  // Nang added on  19-Sep-2012	
	$field_value[57]=xml_get_ele($da_sd_evn_evn_obj, "ORGDIGITIZE");	// Nang added on  19-Sep-2012	
...
// Else, UPDATE
	...
	$field_name[51]="sd_evn_foc";            // Nang added on  19-Sep-2012
	$field_name[52]="sd_evn_ori";	         // Nang added on  19-Sep-2012	
	...
	$field_value[51]=xml_get_ele($da_sd_evn_evn_obj, "FOCALPLANESOL");  // Nang added on  19-Sep-2012	
	$field_value[52]=xml_get_ele($da_sd_evn_evn_obj, "ORGDIGITIZE");	// Nang added on  19-Sep-2012	
