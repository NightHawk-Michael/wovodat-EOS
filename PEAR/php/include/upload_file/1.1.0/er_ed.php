...
if ($id==NULL) {
	...
	$field_name[12]="ed_vei";             /* Nang added on 10-Mar-2015  */
	$field_name[13]="ed_com";
	$field_name[14]="vd_id";
	$field_name[15]="cc_id";
	$field_name[16]="cc_id2";
	$field_name[17]="cc_id3";
	$field_name[18]="ed_pubdate";
	$field_name[19]="cc_id_load";
	$field_name[20]="ed_loaddate";
	...
	$field_value[12]=xml_get_ele($er_ed_obj, "ERUPTVEI");         /* Nang added on 10-Mar-2015  */
	$field_value[13]=xml_get_ele($er_ed_obj, "COMMENTS");
	$field_value[14]=$er_ed_obj['results']['vd_id'];
	$field_value[15]=$er_ed_obj['results']['owners'][0]['id'];
	$field_value[16]=$er_ed_obj['results']['owners'][1]['id'];
	$field_value[17]=$er_ed_obj['results']['owners'][2]['id'];
	$field_value[18]=$er_ed_obj['results']['pubdate'];
