...
if ($id==NULL) {
	...
	$field_value[10]=xml_get_ele($ms_dn_ds_dig_obj, "ORGDIGITIZE");   //Nang added on 13-Sep-2012		
	...
	$field_value[20]=NULL;                     // Nang updated on 22-Dec-2014
...
// Else, UPDATE
	...
	$field_value[16]=NULL;                     // Nang updated on 22-Dec-2014
