...
if ($id==NULL) {
	...
	$field_name[6]="co_com";           //Nang added on 27-Sep-2012	
	$field_name[7]="vd_id";
	$field_name[8]="cc_id";
	$field_name[9]="cc_id2";
	...
	$field_value[6]=xml_get_ele($ob_co_obj, "COMMENTS");	     //Nang added on 27-Sep-2012	
...
// Else, UPDATE
	...
	$field_name[5]="co_com";           //Nang added on 27-Sep-2012		
	$field_name[6]="vd_id";
	...
	$field_value[5]=xml_get_ele($ob_co_obj, "COMMENTS");	     //Nang added on 27-Sep-2012	
