...
if ($id==NULL) {
	...
	$field_name[16]="sd_trm_ori";                 // Nang added on 19-Sep-2012	
	$field_name[17]="sd_trm_com";                 // Nang added on 19-Sep-2012	
	$field_name[18]="sn_id";
	$field_name[19]="ss_id";
	$field_name[20]="cc_id";
	...
	$field_value[16]=xml_get_ele($da_sd_trm_trm_obj, "ORGDIGITIZE");          // Nang added on 19-Sep-2012	
	$field_value[17]=xml_get_ele($da_sd_trm_trm_obj, "COMMENTS");	          // Nang added on 19-Sep-2012		
