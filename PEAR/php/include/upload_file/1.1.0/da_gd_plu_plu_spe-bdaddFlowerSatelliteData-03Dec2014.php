...
if ($id==NULL) {
	...
	$field_name[13]="gd_plu_wsmin";	  // Nang added on 17-Sep-2012     
	$field_name[14]="gd_plu_wsmax";	  // Nang added on 17-Sep-2012   
	$field_name[15]="gd_plu_wdir";	  // Nang added on 08-May-2012         
	$field_name[16]="gd_plu_weth";
	$field_name[17]="gd_plu_ori";	  // Nang added on 08-May-2012 
	$field_name[18]="gd_plu_com";
	$field_name[19]="cs_id";	      // Nang added on 31-May-2012  
	$field_name[20]="gs_id";
	$field_name[21]="gi_id";
	$field_name[22]="vd_id";
	$field_name[23]="cc_id";
	...
	$field_value[13]=xml_get_ele($da_gd_plu_plu_obj, "MINWINDSPEED");	 // Nang added on 17-Sep-2012 
	$field_value[14]=xml_get_ele($da_gd_plu_plu_obj, "MAXWINDSPEED");	 // Nang added on 17-Sep-2012 	
	$field_value[15]=xml_get_ele($da_gd_plu_plu_obj, "WINDDIRECTION");	 // Nang added on 08-May-2012 
	$field_value[16]=xml_get_ele($da_gd_plu_plu_obj, "WEATHERNOTES");
	$field_value[17]=xml_get_ele($da_gd_plu_plu_obj, "ORGDIGITIZE");	 // Nang added on 08-May-2012 
	$field_value[18]=xml_get_ele($da_gd_plu_plu_obj, "COMMENTS");
	$field_value[19]=$cs_id;	                                         // Nang added on 31-May-2012  
