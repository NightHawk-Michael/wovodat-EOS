...
if ($id==NULL) {
	...
	$field_name[7]="sd_int_ori";           // Nang added on 19-Sep-2012	
	$field_name[8]="sd_int_com";           // Nang added on 19-Sep-2012	
	...
	$field_value[7]=xml_get_ele($da_sd_int_int_obj, "ORGDIGITIZE");           // Nang added on 19-Sep-2012	
	$field_value[8]=xml_get_ele($da_sd_int_int_obj, "COMMENTS");	          // Nang added on 19-Sep-2012	
