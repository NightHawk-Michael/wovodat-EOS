...
if ($id==NULL) {
	...
	$field_value[14]=xml_get_ele($ms_dn_ds_obj, "ORGDIGITIZE");   //Nang added on 13-Sep-2012		
	$field_value[15]=xml_get_ele($ms_dn_ds_obj, "COMMENTS");      //Nang added on 13-Sep-2012		
