...
if ($id==NULL) {
	...
	$field_value[21]=xml_get_ele($ms_si_si_obj, "ORGDIGITIZE");	          // Nang added on 19-Sep-2012		
...
// Else, UPDATE
	...
	$field_value[17]=xml_get_ele($ms_si_si_obj, "ORGDIGITIZE");	          // Nang added on 19-Sep-2012		
