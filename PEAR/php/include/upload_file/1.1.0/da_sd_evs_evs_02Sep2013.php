...
if ($id==NULL) {
	...
	$field_name[13]="sd_evs_ori";                       //  Nang added on 19-Sep-2012
	$field_name[14]="sd_evs_com";                       //  Nang added on 19-Sep-2012
	$field_name[15]="ss_id";
	$field_name[16]="cc_id";
	...
	$field_value[13]=xml_get_ele($da_sd_evs_evs_obj, "ORGDIGITIZE");          // Nang added on 19-Sep-2012	
	$field_value[14]=xml_get_ele($da_sd_evs_evs_obj, "COMMENTS");	          // Nang added on 19-Sep-2012	
